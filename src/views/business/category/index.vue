<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['business:category:add']"
          >新增</el-button
        >
      </el-col>
      <el-col :span="1.5">
...
import type { DishCategory, CategoryQueryParams } from '@/types/api/business/category'
...
function handleSelectionChange(selection: DishCategory[]) {
...
function handleUpdate(row?: DishCategory) {
  reset()
...
function handleDelete(row?: DishCategory) {
