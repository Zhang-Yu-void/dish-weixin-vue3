<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="warning" plain icon="Check" @click="handleSaveSort" v-hasPermi="['system:dept:edit']"
          >保存排序</el-button
        >
      </el-col>
      <el-col :span="1.5">
...
function recordOriginalOrders(list: SysDept[]) {
  list.forEach((item) => {
    if (item.deptId !== undefined) originalOrders.value[item.deptId] = item.orderNum ?? 0
