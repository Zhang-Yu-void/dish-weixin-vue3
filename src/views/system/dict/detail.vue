          ...
          <div class="dict-cell">
            ...
            <div class="dict-cell-val">
              <el-tag
                ...
                :type="getListClassType(item.listClass)"
                size="small"
...
function getListClassType(listClass: string): TagType {
  if (!listClass || listClass === 'default' || listClass === 'primary') {
    return undefined
  }
  return listClass as TagType
}
